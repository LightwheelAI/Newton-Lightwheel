...
class Example:
    def __init__(
        ...
        stage = Usd.Stage.Open(str((Path(__file__).parent /"scene_sand.usda").resolve()))
        ...
        yp = sand_yield_pressure
        ys = sand_yield_stress
        tyr = sand_tensile_yield_ratio
        frictions = sand_friction_array
        hardening = sand_hardening
        colors = sand_color
        # parse scene 
