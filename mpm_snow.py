...
class Example:
    def __init__(
        ...
        stage = Usd.Stage.Open(str((Path(__file__).parent /"scene_snow.usda").resolve()))
        ...
        yp = snow_yield_pressure
        ys = snow_yield_stress
        tyr = snow_tensile_yield_ratio
        frictions = snow_friction_array
